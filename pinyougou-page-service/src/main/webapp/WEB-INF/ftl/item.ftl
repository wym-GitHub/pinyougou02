							...
							<#list specificationList as spec>
                                <dl>
									...
									<#list spec.attributeValue as value>
										<dd><a class="{{isSelected('${spec.attributeName}','${value}')?'selected':''}}" href="javascript:;" ng-click="selectSpecification('${spec.attributeName}','${value}')">${value}<span title="点击取消选择">&nbsp;</span></a></dd>
									</#list>
